...
- `README.md` — the short command list under the normal loop, the layer table under What assaio
  measures, and the source list. All three have gone stale before, and once together: a shipped command missing
