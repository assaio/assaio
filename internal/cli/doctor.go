...
reach it.`,
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			cmd.Println("  - The price table carries no long-context (e.g. [1m]) rate, so cost for a very")
			cmd.Println("    long-context session is an under-estimate. The 1-hour cache-write tier is priced.")
