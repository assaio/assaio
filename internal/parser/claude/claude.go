...
func recordFromLine(l *line, cf *carryForward) usage.Record {
	...
	return usage.Record{
		...
		InputTokens:      l.Message.Usage.Input,
		OutputTokens:     l.Message.Usage.Output,
		CacheReadTokens:  l.Message.Usage.CacheRead,
		CacheWriteTokens: l.Message.Usage.CacheWrite,
		DedupeKey:        l.UUID,
		Cwd:              cf.cwd,
		Project:          cf.project(),
